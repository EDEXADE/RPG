...
Core system = Core.Initialize();
Player player = system._crControl.NewPlayer("Player", new Human());
system._expControl.AddExp(player, 1000);
// (1 0/500) + 1000 = (2 0/1000) + 500 = 2 500/1000
system._expControl.AddExp(player, 5000);
